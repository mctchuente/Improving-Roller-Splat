...
{
    public Rigidbody rb;//Component wich takes care of mouvement
    ...
    private void Start()
    {
        solveColor = Random.ColorHSV(0.5f, 1);// Only take pretty light colors
        GetComponent<MeshRenderer>().material.color = solveColor;
        playerAudio = GetComponent<AudioSource>();
    }
    
    //method called 30/60 times per seconds
    void FixedUpdate()
    {
